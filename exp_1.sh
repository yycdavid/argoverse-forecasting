...
CUDA_VISIBLE_DEVICES=1 python lstm_prog_reg.py --mode train --train_path ../argoverse_data/processed/train_pen_2_split.pkl --val_path ../argoverse_data/processed/val_pen_2_split.pkl --test_path ../argoverse_data/processed/val_pen_2.pkl --split --lr 0.0002 --t_ratio 0.1 --v_ratio 20.0 --result_dir reg_lr_2e4_t01_v20
